...
public enum MasonXIdPrefix {
    ...
    CARD_CLEARING_EVENT("cclr_"),
    CARD_CLOSE_TRANSACTION("tx_close_"),
    CARD_FUND_TRANSACTION("tx_fund_"),
    CARD_PROGRAM("cprog_"),
    CARD_SETTLEMENT_REPORT("csr_"),
    CARD_SETTLEMENT_REPORT_LINE("csrl_"),
    CARD_WITHDRAW_TRANSACTION("tx_wd_"),
    CARDHOLDER("ch_"),
    FEE_ASSESSMENT("feeas_"),
    FEE_SCHEDULE("fees_"),
    FEE_TRANSACTION("tx_fee_"),
